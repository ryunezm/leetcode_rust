...
pub fn search_insert(nums: Vec<i32>, target: i32) -> i32 {
    ...
    match nums.len()-1 {
        ...
        1 => {
            ...
            else if target>nums[0] && target<=nums[1] {return 1;}
        ...
        2 => {
            ...
            else if target>nums[1] && target<=nums[2] {return 2;}
            else if target>nums[2] {return 3;}
        ...
        _ => {
            ...
            loop{
                if target <= nums[i as usize] {return i;}
                else if target == nums[m as usize] {return m;}
                else if target == nums[j as usize] {return j;}
                else if target > nums[j as usize] {return j+1;}
